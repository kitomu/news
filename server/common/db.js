...
class Db {
  constructor(){
    ...
    this.initialSQL = [
      ...
      "CREATE TABLE users (id INTEGER AUTO_INCREMENT, name VARCHAR(20) NOT NULL DEFAULT 'NULL', fname VARCHAR(20) NOT NULL DEFAULT 'NULL', login VARCHAR(20) NOT NULL DEFAULT 'NULL', salt VARCHAR(200) NOT NULL DEFAULT 'NULL', passwordHash VARCHAR(200) NOT NULL DEFAULT 'NULL', mail VARCHAR(20) NOT NULL DEFAULT 'NULL', img_avatar VARCHAR(100) NULL DEFAULT NULL, PRIMARY KEY (id)), UNIQUE KEY (mail)",
